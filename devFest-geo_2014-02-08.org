...
- Pretty easy! (Follow along with [[http://www.nceas.ucsb.edu/scicomp/usecases/shapeFileToKML][this]], [[http://stackoverflow.com/questions/7813141/how-to-create-a-kml-file-using-r][this]], and [[http://stackoverflow.com/questions/21487010/assistance-with-name-and-styleurl-in-kml-when-using-writeogr-from-rgdal][this]])
...
#+name: transpo-plot
#+header: :file ./img/transpo-plot.pdf :width 11 :height 6
#+begin_src R :session r :results output graphics :exports both :eval no
...
- Helpful function found [[http://theweiluo.wordpress.com/2011/09/30/r-to-json-for-d3-js-and-protovis/][here]]
...
* todo ideas for remaining slides

- 3M center with work activity (get data from timesheet app)
- Re-populate references
- Possibly mention tools (emacs, orgmode...)
